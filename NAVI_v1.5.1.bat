...
echo [InternetShortcut] > "%AllUsersProfile%\Desktop\Kronos.url"
set "kronos=https://lkq.kronos.net/wfc/applications/wtk/html/ess/quick-tslite.jsp?noclear=yes&c_timeout=2&nologon=yes"
echo URL=!kronos! >> "%AllUsersProfile%\Desktop\kronos.url"
echo IDList= >> "%AllUsersProfile%\Desktop\kronos.url"
echo IconIndex=0 >> "%AllUsersProfile%\Desktop\kronos.url"
echo HotKey=0 >> "%AllUsersProfile%\Desktop\kronos.url"

echo Creating ProjectX Link...
echo [InternetShortcut] > "%AllUsersProfile%\Desktop\ProjectX.url"
echo URL=http://lkqpxweb/security/ >> "%AllUsersProfile%\Desktop\ProjectX.url"
echo IDList= >> "%AllUsersProfile%\Desktop\ProjectX.url"
echo IconIndex=0 >> "%AllUsersProfile%\Desktop\ProjectX.url"
echo HotKey=0 >> "%AllUsersProfile%\Desktop\ProjectX.url"

echo Creating Outlook Web Link...
echo [InternetShortcut] > "%AllUsersProfile%\Desktop\OutlookWebApp.url"
echo URL=https://outlook.lkqcorp.com >> "%AllUsersProfile%\Desktop\OutlookWebApp.url"
echo IDList= >> "%AllUsersProfile%\Desktop\OutlookWebApp.url"
echo IconIndex=0 >> "%AllUsersProfile%\Desktop\OutlookWebApp.url"
echo HotKey=0 >> "%AllUsersProfile%\Desktop\OutlookWebApp.url"

echo Creating Finesse Link... 
echo [InternetShortcut] > "%AllUsersProfile%\Desktop\Finesse.url"
echo URL=http://agentlogin1/desktop >> "%AllUsersProfile%\Desktop\Finesse.url"
echo IDList= >> "%AllUsersProfile%\Desktop\Finesse.url"
echo IconIndex=0 >> "%AllUsersProfile%\Desktop\Finesse.url"
echo HotKey=0 >> "%AllUsersProfile%\Desktop\Finesse.url"

echo Creating Printer Installer Tool Link... 
echo [InternetShortcut] > "%AllUsersProfile%\Desktop\Printertool.url"
echo URL=http://printertool/ >> "%AllUsersProfile%\Desktop\Printertool.url"
echo IDList= >> "%AllUsersProfile%\Desktop\Printertool.url"
echo IconIndex=0 >> "%AllUsersProfile%\Desktop\Printertool.url"
echo HotKey=0 >> "%AllUsersProfile%\Desktop\Printertool.url"
echo.
