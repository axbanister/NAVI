...
echo     2. Uninstall or Repair a program
echo     3. Outlook Prompting for Credentials
echo     4. Troubleshoot Internet Explorer
echo     5. Troubleshoot Prelude Reporting
echo     6. Add Desktop Shortcuts
echo     7. Restart Computer
echo     8. Exit
echo.
echo.

CHOICE /N /C 12345678 /M "Choose a menu option by pressing the number."
if errorlevel 8 == goto Exit
if errorlevel 7 == goto restart
if errorlevel 6 == goto shortcuts
if errorlevel 5 == goto preludereporting
if errorlevel 4 == goto troubleshootIE
if errorlevel 3 == goto outlookcreds
